...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public boolean addOne(CustomerModel studentMod){
    ...
    public boolean DeleteOne(CustomerModel studentMod){
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public List<CustomerModel> getEveryone(){
        ...
        if(cursor.moveToFirst()){
            ...
            do{
                ...
                CustomerModel newStudent = new CustomerModel(SID, SName, SAge);
